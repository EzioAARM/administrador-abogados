			...
			<div class="row">
				<div class="col-md-7 col-md-offset-1">
					...
					<p class="description">
						...
						<a href="{{ url('trabajadores/archivo/descargar/' . $archivos[0]->nombre_servidor . '/' . $archivos[0]->trabajador_id) }}" class="btn btn-success"><i class="pe-7s-cloud-download"> </i> Descargar Archivo</a>
					</p>
				</div>
			</div>
		</div>
