...
<div class="card">
	<div class="header">
		...
		<p class="category">Agregar un nuevo archivo del trabajador</p>
	</div>
	<div class="content">
	...
	<div class="content">
		<form method="post" action="{{ url('archivos/trabajadores/agregar') }}" enctype="multipart/form-data">
			{{ csrf_field() }}
			<input type="hidden" id="trabajador-id" name="trabajador-id" value="{{ $trabajador_id }}">
