...
<div class="card">
	<div class="header">
		...
		@if ($tipo == 'propio')
			<p class="category">Agregar un nuevo abogado a favor del cliente</p>
		@else 
			<p class="category">Agregar un nuevo abogado contrario al cliente</p>
		@endif
	</div>
	<div class="content">
		<form method="post" action="{{ url('abogados/agregar') }}">
			{{ csrf_field() }}
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
		                        ...
		                        <input type="text" required="" name="numero-colegiado" id="numero-colegiado" class="form-control" placeholder="Número de Colegiado" value="">
		                    </div>
						</div>
					</div>
				</div>
