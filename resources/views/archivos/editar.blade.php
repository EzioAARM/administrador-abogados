...
<div class="card">
	<div class="header">
		...
		<p class="category">Editar un archivo del cliente</p>
	</div>
	<div class="content">
		<form method="post" action="{{ url('archivos/editar') }}" enctype="multipart/form-data">
			{{ csrf_field() }}
			<input type="hidden" id="id" name="id" value="{{ $archivos[0]->id }}">
			<input type="hidden" id="cliente-id" name="cliente-id" value="{{ $archivos[0]->cliente_id }}">
